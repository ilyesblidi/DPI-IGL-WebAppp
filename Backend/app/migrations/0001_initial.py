    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('patient', 'Patient'), ('medecin', 'Medecin'), ('infirmier', 'Infirmier'), ('radiologue', 'Radiologue'), ('laborantin', 'Laborantin'), ('pharmacien', 'Pharmacien')], default='admin', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_examen', models.DateTimeField(default=datetime.datetime.now)),
                ...
                ('compte_rendu', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='examen_radiologiques', to='app.compte_rendu')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('examen_radiologique', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='resultat', to='app.examen_radiologique')),
            ],
        ),
        migrations.CreateModel(
            name='Infirmier',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('laboratoire', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bilans_biologiques', to='app.laboratoire')),
            ],
        ),
        migrations.CreateModel(
            name='Medecin',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dpis', to='app.medecin'),
        ),
        migrations.AddField(
            model_name='consultation',
            name='medecin',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='consultations', to='app.medecin'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medecin', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='certificats', to='app.medecin')),
            ],
        ),
        migrations.CreateModel(
            name='Ordonnance',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pharmacien_profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Radiologue',
        ...
        migrations.AddField(
            ...
            name='Radiologue',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='examens_radiologiques', to='app.radiologue'),
        ),
        migrations.AddField(
            model_name='compte_rendu',
            name='radiologue',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='compte_rendus', to='app.radiologue'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospitalisation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='decompte', to='app.hospitalisation')),
                ('admin', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='decomptes', to='app.admin')),
            ],
        ),
    ]
